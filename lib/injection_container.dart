...
Future<void> init() async {
  ...
  sl.registerFactory<SecondCubicCubit>(() => SecondCubicCubit(
        getTopRatedMoviesUseCase: sl.call(),
      ));

  //use cases
  sl.registerLazySingleton<GetPopularesMoviesUseCase>(
      () => GetPopularesMoviesUseCase(repository: sl.call()));
  sl.registerLazySingleton<GetTopRatedMoviesUseCase>(
      () => GetTopRatedMoviesUseCase(repository: sl.call()));

  //repository
  sl.registerLazySingleton<MoviesRepository>(
      () => MoviesRepositoryImpl(remoteDataSource: sl.call()));

  //remote data
  sl.registerLazySingleton<MoviesRemoteDataSource>(
      () => MoviesRemoteDataSourceImpl(client: sl.call()));
